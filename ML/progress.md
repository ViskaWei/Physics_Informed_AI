...
> 💪 **今日目标**: 🔴 P0 `window` 2题（滑动窗口特征转换、历史窗口搜索）  
> 🎯 **剩余任务**: 选择题 7 套，编程 35 套
> 📝 **备注**: 0828 只有 coding，无选择题
...
| 日期 | 选择题1刷 | 编程1 | 编程2 | 状态 |
|------|---------------|-------|-------|------|
| 2025-08-27 | - | feature | tree | 🔴 空 |
| 2025-09-03 | - | moe | reg | 🔴 空 |
| 2025-09-04 | - | feature | reg | 🔴 空 |
| 2025-09-05 | - | tree | dp | 🔴 空 |
| 2025-09-10 | - | window | window | 🔴 空 |
| 2025-09-12 | - | graph | ✅ att | 🟡 部分 |
| 2025-09-17 | ✅1/4 | ✅ att | tokenizer | 🟡 部分 |
| 2025-09-18 | ✅1/4 | ✅ conv | dp | 🟡 部分 |
| 2025-09-24 | - | cluster | tree | 🔴 空 |
| 2025-09-28 | ✅1/4 | cluster | ✅ att | 🟡 部分 |
| 2025-10-10 | ✅1/4 | cluster | rnn | 🟡 部分 |
| 2025-10-10us | ✅1/4 | feature | reg | 🟡 部分 |
| 2025-10-15 | ✅1/4 | ✅ att | cluster | 🟡 部分 |
| 2025-10-17 | ✅1/4 | cluster | rnn | 🟡 部分 |
| 2025-10-22 | ✅1/4 | ✅ conv | ✅ att | 🟢 完成 |
| 2025-10-23 | ✅1/2 | feature | ✅ conv | 🟡 部分 |
| 2025-10-29 | ✅1/1 | feature | reg | 🟡 部分 |
| 2025-11-05 | ✅1/1 | feature | dp | 🟡 部分 |
| 2025-11-06 | ✅1/1 | reg | ✅ conv | 🟡 部分 |
| 2025-11-12 | ✅1/1 | quant | tree | 🟡 部分 |
| 2025-11-19 | ✅1/1 | cluster | graph | 🟡 部分 |
| 2025-11-20 | ✅12/30 | ✅ att | ✅ conv | 🟢 完成 |
| 2025-12-03 | ✅12/30 | prune | cluster | 🟡 部分 |
| 2025-12-17 | ✅12/29 | reg | quant | 🟡 部分 |
| **总进度** | **17/25** | **5/25** | **6/25** | **11/46 ✅** |
...
| 主题 | 首刷 | 二刷 | 目标 | 1/8优先级 |
|------|------|------|------|-----------|
| 滑动窗口/区间 (window) | 0 | 0 | ≥2 | 🔴 P0 |
| Tokenizer/BPE (tokenizer) | 0 | 0 | ≥1 | 🔴 P0 |
| 稀疏注意力/MoE路由 (moe) | 1 | 0 | ≥2 | 🔴 P0 ✅ |
| LSTM/RNN (rnn) | 0 | 0 | ≥1 | 🟡 P1 |
| 树/图题（算法）(graph) | 0 | 0 | ≥2 | 🟡 P1 |
| DP/路径 (dp) | 1 | 0 | ≥3 | 🟡 P1 |
| 决策树/剪枝 (tree) | 0 | 0 | ≥3 | 🟢 P2 |
| 特征工程 (feature) | 0 | 0 | ≥1 | 🟢 P2 |
| 注意力/Transformer (att) | 6 | 0 | ≥5 | ⚪ P3 ✅ |
| 卷积/实现 (conv) | 0 | 0 | ≥3 | ⚪ P3 |
| 聚类/KMeans (cluster) | 0 | 0 | ≥3 | ⚪ P3 |
| 回归/分类 (reg) | 0 | 0 | ≥3 | ⚪ P3 |
| 量化 (quant) | 0 | 0 | ≥2 | ⚪ P3 |
| 剪枝 (prune) | 0 | 0 | ≥1 | ⚪ P3 |
| ViT/PatchEmbedding | 0 | 0 | ≥1 | ⚪ P3 |
| LoRA/参数高效 | 0 | 0 | ≥1 | ⚪ P3 |
| 概率/随机过程 | 0 | 0 | ≥1 | - |
...
> 📎 详细分析见: [ai_core46_index.md](./coding/ai_core46_index.md#🎯-18-考试-tag-优先级预测)
...
### Prefill vs Decode 瓶颈（LLM推理）
- **题目特征**: 长prompt短生成 vs 短prompt长生成
- **核心结论**: Prefill=计算瓶颈(Tensor Core)；Decode=带宽瓶颈(HBM读KV cache)
- **易错点**: 误以为INT4量化能优化Decode（KV cache不是权重）

### 绝对 vs 相对位置编码
- **易错点**: 误以为 sin/cos PE 是相对位置编码
- **正确理解**: 标准 sin/cos PE 是绝对位置编码，输入是 pos 不是 (pos_q - pos_k)

### all-reduce 分解
- **公式**: all-reduce = reduce-scatter + all-gather
- **核心结论**: 消息大（长序列/大batch）时拆分更高效，可与计算重叠
- **易错点**: 误以为低带宽下也应该拆分

### 泊松 vs 指数分布
- **泊松**: $E[X] = \mathrm{Var}(X) = \lambda$（计数/次数）
- **指数**: $E[X] = 1/\lambda$，$\mathrm{Var}(X) = 1/\lambda^2$（等待时间）
- **易错点**: 混淆两者，记住指数 $E \neq \mathrm{Var}$
...
### 2025-09-28 薄弱环节 Top-3

| 排名 | 知识点 | 错/总 | 正确率 | 备注 |
|------|--------|-------|--------|------|
| 1 | 评估指标 | 1/1 | 0% | 样本少；AUC vs F1 |
| 2 | 大模型(LLM) | 1/2 | 50% | TextRank/LDA 不熟悉 |
| 3 | 注意力与Transformer | 1/2 | 50% | Causal Mask ≠ 局部性 |

### 2025-09-17 薄弱环节 Top-3
...
### 2025-10-22 薄弱环节 Top-3

| 排名 | 知识点 | 错/总 | 正确率 | 备注 |
|------|--------|-------|--------|------|
| 1 | 注意力与Transformer | 1/2 | 50% | Scaled Dot-Product 缩放作用 |
| 2 | 经典机器学习 | 1/2 | 50% | Target Encoding + Embedding |
| 3 | 概率统计 | 2/6 | 67% | 独立性、泊松分布 |

### 2025-10-10 薄弱环节 Top-3

| 排名 | 知识点 | 错/总 | 正确率 | 备注 |
|------|--------|-------|--------|------|
| 1 | 其他(可视化) | 1/1 | 0% | 样本少；两连续变量看关系先散点 |
| 2 | - | - | - | 其他知识点无明确错题 |
| 3 | - | - | - | - |

### 2025-10-10us 薄弱环节 Top-3
...
- [20250917.md](./multichoice/20250917.md) - AI方向题 ✅已整理
- [20250918.md](./multichoice/20250918.md) - 留学生AI方向题 ✅已整理
- [20250928.md](./multichoice/20250928.md) - AI方向题 ✅已整理
- [20251023.md](./multichoice/20251023.md) - 留学生AI方向题 ✅已整理
- [20251029.md](./20251029.md) - AI方向题 ✅已整理
- [20251105.md](./20251105.md) - AI方向题
- [20251106.md](./20251106.md) - 留学生AI方向题 ✅已整理
- [20251112.md](./20251112.md) - AI方向题 ✅已整理
- [20251015.md](./multichoice/20251015.md) - AI方向题 ✅已整理
- [20251017.md](./multichoice/20251017.md) - AI方向题 ✅已整理
- [20251022.md](./multichoice/20251022.md) - AI方向题 ✅已整理
- [20251119.md](./20251119.md) - AI方向题 ✅已整理
- [20251010.md](./multichoice/20251010.md) - AI方向题 ✅已整理
- [20251010us.md](./multichoice/20251010us.md) - 留学生AI方向题 ✅已整理
- [20251120.md](./20251120.md) - 留学生AI方向题 📝待整理
- [20251203.md](./20251203.md) - AI方向题 📝待整理
- [20251217.md](./20251217.md) - AI方向题 📝待整理
