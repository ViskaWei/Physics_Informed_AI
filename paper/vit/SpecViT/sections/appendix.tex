...
This Appendix provides expanded numerical results referenced in the main Results section, including additional metrics for \textsc{SpecViT}, the full scaling table, and per-SNR values used in Figure~\ref{fig:main_results}.
...
\subsection{Per-SNR values underlying Figure~\ref{fig:main_results}}
...
\section{Fisher-Information Ceiling: Derivation and Interpretation}
\label{app:fisher_extra}

This Appendix provides the mathematical derivation for converting Fisher information to an $R^2$ ceiling, as referenced in Section~\ref{subsec:results_fisher}.
