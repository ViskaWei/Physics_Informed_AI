...
\end{minipage}
\caption{
\textbf{Left:} Scaling of $\log g$ inference performance with training set size $N$. \textsc{SpecViT} improves rapidly with data and overtakes LightGBM at $N\sim10^5$, then saturates beyond $N\gtrsim5\times10^5$.
