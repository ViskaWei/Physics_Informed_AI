...
> **Scope:** <数据/任务/场景>  
> **Author:** Viska Wei | **Date:** TODO | **Status:** 🔄 Exploring / ✅ Stable  
...
> **注意:** 问题树只展开到"可影响决策的分支层"，细粒度子问题放 Roadmap

---

## 2) Canonical Evaluation Protocol（数字口径冻结）
...
> **规则:** 一般 5-8 条洞见足够；每条必须有 "决策影响"，否则删掉

---

## 5) Decision Gaps（下一步要补的知识空白）
