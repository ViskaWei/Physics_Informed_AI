...
> **本节链接到 experiments_index 和其他仓库**

### 相关实验索引

| experiment_id | project | 状态 | 对应 exp.md |
|---------------|---------|------|-------------|
| `[ID]` | VIT / BlindSpot | ✅/🔄 | [链接](./exp_xxx.md) |
...
| 类型 | 文件路径 | 说明 |
|------|---------|------|
| 主框架 | `logg/[topic]/[topic]_main_YYYYMMDD.md` | 当前文件 |
...
| 资源 | 路径 | 说明 |
|------|------|------|
| 实验索引 | `experiments_index/index.csv` | 中央实验追踪 |
| 待办清单 | `status/next_steps.md` | 跨仓库 backlog |
| 周报 | `reports/drafts/` | 自动生成报告 |
| VIT 仓库 | `~/VIT/` | 训练代码与结果 |
| BlindSpot 仓库 | `~/BlindSpotDenoiser/` | 去噪与 latent 实验 |
