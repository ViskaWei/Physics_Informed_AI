...
### 图 1：误差 vs 模型大小
![图片](../img/1_error_vs_model_size.png)
...
### 图 2：误差 vs 超参数
![图片](../img/2_error_vs_hyperparams.png)
...
### 图 3：超参数热力图
![图片](../img/3_hyperparameter_heatmap.png)
...
### 图 4：效率 vs 性能
![图片](../img/4_efficiency_vs_performance.png)
...
### 图 5：模型大小 vs 训练时间
![图片](../img/5_model_size_vs_time.png)
...
### 图 6：收益递减曲线
![图片](../img/6_time_vs_r2_diminishing_returns.png)
