...
---
> **实验名称：** MLP/CNN 架构系统性探索与数据量效应分析 (53 实验综合报告)  
> **对应 MVP：** NN Baseline 完整分析  
> **作者：** Viska Wei  
> **日期：** 2025-11-30  
> **数据版本：** HDF5 光谱数据（4096 像素合成光谱），32k & 100k 训练集  
> **模型版本：** MLP/CNN Baseline + Residual + Deep/Wide 变体 (PyTorch)  
> **状态：** ✅ 已完成
