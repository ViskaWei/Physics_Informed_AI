...
| **C10** 🆕 | **Ridge α 倒 U 型曲线** | **SCALING-20251222** | **最优 α: 100k=3.16e4, 1M=1e5; 优化后 R²: 0.4856/0.5017** | 🟢 高 |
...
| SCALING-20251222 | 1M 样本最优 α = 1.00e+05 | R² = 0.5017, +0.42% vs baseline |
...
| 1M | 1.0 | **1.00e+05** | **0.5017** | 0.4997 | +0.42% |
...
│                   │ CNN:    ?               CNN:   ?          CNN:   ?          │
├───────────────────┼─────────────────────────────────────────────────────────────┤
│ Noise = 1.0       │ Ridge:  0.458 ✅        Ridge: 0.4856 ✅🆕  Ridge: 0.5017 ✅🆕 │
