...
| **🔴 MVP-Next-C** | **Expert 校准** | **11** | **⏳ 立项** | `VIT-20251204-moe-calibration-01` | [exp](./exp_moe_expert_calibration_20251204.md) |
...
│   ⏳ 计划中   │  🔴 待执行   │  🚀 运行中   │   ✅ 已完成   │   ❌ 已取消   │
├──────────────┼──────────────┼──────────────┼──────────────┼──────────────┤
│ MVP-4.0      │ MVP-Next-A   │              │ MVP-0        │ MVP-7.1~7.3  │
│ MVP-6.0      │ MVP-Next-B   │              │ MVP-1.0      │ MVP-PG2      │
│ MVP-PG3      │ MVP-Next-C   │              │ MVP-1.1 ✓    │              │
│              │              │              │ MVP-2.0      │              │
│              │              │              │ MVP-3.0 ✓    │              │
│              │              │              │ MVP-3.1 ❌   │              │
│              │              │              │ MVP-3.2 ✓    │              │
