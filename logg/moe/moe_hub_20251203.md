# 🧠 MoE Hub
> **Name:** Mixture of Experts | **ID:** `VIT-20251203-moe-hub`  
> **Topic:** `moe` | **Layer:** L1 (Cross-Cutting) | **Project:** `VIT`  
> **Author:** Viska Wei | **Date:** 2025-12-03 | **Status:** 🟢 Phase 15 Done
```
💡 MoE 要不要上？什么时候有用？  
决定：是否采用专家混合架构、门控策略选择
```
> **Focus:** Phase 16 (1M + noise=1 大规模低 SNR 验证)
...
## 📁 Data Source (Oracle MoE @ noise=1)

| 属性 | 值 |
|------|-----|
| **Dataset** | BOSZ 50000 合成光谱 |
| **Root** | `/datascope/subaru/user/swei20/data/bosz50000/z0/mag205_225_lowT_1M/` |
| **Train** | 5 shards × 200k = **1,000,000 samples** |
| **Test** | test_1k_0 = **1,000 samples** |
...
| 参数 | 边界 | Bins |
|------|------|------|
| **Teff** | [3750, 4500, 5250, 6000] | Cool, Mid, Hot |
| **[M/H]** | [-2.0, -1.0, 0.0, 0.5] | Poor, Solar, Rich |

### Per-Bin 样本分布

| Bin | Teff | [M/H] | n_train | n_test |
|-----|------|-------|---------|--------|
| 0 | Cool | Poor | 88,666 | 93 |
| 1 | Cool | Solar | 89,050 | 85 |
| 2 | Cool | Rich | 62,702 | 71 |
| 3 | Mid | Poor | 102,801 | 89 |
| 4 | Mid | Solar | 102,864 | 111 |
| 5 | Mid | Rich | 71,516 | 62 |
| 6 | Hot | Poor | 116,727 | 117 |
| 7 | Hot | Solar | 115,778 | 126 |
| 8 | Hot | Rich | 80,717 | 81 |
