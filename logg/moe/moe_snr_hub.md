...
* ⚠️ ~~**P0 (MVP-4.0)**~~：双塔融合 → **已完成**: ΔR²=+0.0017 MARGINAL，Fallback to Phys-only
* 🔴 **P0 (生产化)**：Phys-only Gate (13D) + Soft routing 作为最终 MoE 方案
* 🟢 **P1 (集成)**：将 MoE 集成到 ViT 模型中
* 🟡 **P2 (可选)**：条件性融合 — 仅在低 SNR (≤2) 使用 quality gate
